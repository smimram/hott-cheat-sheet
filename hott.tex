...
\noindent
{\footnotesize Disclaimer: the contents of this note was contributed by students of the course, there is no guarantee of correctness.}
...
Let $A$ a type and $B: A \to \mathcal{U}$ a type family. \textbf{Dependent functions}: $\Pi(x:A).B(x)$. It can also be written as $(x:A) \to B(x)$.
